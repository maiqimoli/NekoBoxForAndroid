...
class QuickToggleShortcut : Activity(), SagerConnection.Callback {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (intent.action == Intent.ACTION_CREATE_SHORTCUT) {
            authorizeShortcutLaunch(Intent.ACTION_CREATE_SHORTCUT) {
                setResult(RESULT_OK, ShortcutManagerCompat.createShortcutResultIntent(this,
                    ShortcutInfoCompat.Builder(this, "toggle")
                        .setIntent(Intent(this,
                            QuickToggleShortcut::class.java).setAction(ACTION_QUICK_TOGGLE))
            ...
            authorizeShortcutLaunch(ACTION_QUICK_TOGGLE) {
